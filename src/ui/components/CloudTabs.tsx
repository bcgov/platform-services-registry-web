        ...
        <div className="flex h-16 justify-between ">
          <div className="flex">
            <div className="md:ml-11 md:flex md:space-x-8">
              <a
                href="#"
                className="inline-flex items-center px-1 pt-1 font-bcsans text-lg font-bold text-bcblue"
              >
                <span className="relative">
                  PRIVATE CLOUD OPENSHIFT
                  <div className="absolute inset-x-0 mx-auto h-4 w-2/3 border-b-3 border-bcorange"></div>
                </span>
              </a>
              <a
                href="#"
                className="inline-flex items-center px-1 pt-1 font-bcsans text-lg font-bold text-deselected "
              >
                <span className="relative">
